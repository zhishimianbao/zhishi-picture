package com.zhishi.picture.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // zhishi_picture.picture_112321321,zhishi_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "zhishi_picture." + tableName) // 确保前缀合法
